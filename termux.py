...
def uaku():
	try:
		...
		a=requests.get('https://github.com/mlkjhgfdsaq1230/Trick/blob/main/File.txt').text
		ua=open('.mix.txt','w')
...
def chk():
  ...
  os.system('xdg-open https://github.com/mlkjhgfdsaq1230')
  ...
  try: 
    httpCaht = requests.get("https://github.com/mlkjhgfdsaq1230/Trick/blob/main/File.txt").text 
    if id in httpCaht: 
      ...
      print('\033[92m[•]\033[97mMY ID : MOHSIN KHAN [ MOHSIN-HUNTER ]')
      print('\033[92m[•]\033[97mYOUR KEY SEND MY WHATSPP')
      os.system('xdg-open https://api.whatsapp.com/send?phone=+923125146881')
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
